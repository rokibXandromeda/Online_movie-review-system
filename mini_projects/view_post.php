...
<body>
    ...
    <script>
        // JavaScript code for rendering the chart will go here
    </script>
</body>
</html>
<?php
...
$fetch_review = [
    '1 Star' =>  $rating_1 += $fetch_rating,
    '2 Star' =>  $rating_2 += $fetch_rating,
    '3 Star' =>  $rating_3 += $fetch_rating,
    '4 Star' =>  $rating_4 += $fetch_rating,
    '5 Star' =>  $rating_5 += $fetch_rating
];

// Convert data into JSON format
$data_json = json_encode($fetch_review);
?>
<script>
    // Get the data generated by PHP
