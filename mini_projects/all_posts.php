...
<head>
   ...
   <style>
   .all-posts {
   background-image: url('uploaded_files/plain.jpg');
   }
   </style>
</head>
<body>
...
<section class="all-posts">
   ...
   <div class="heading"><a href="promotion.php?get_id=<?= $get_id; ?>" class="inline-btn" style="margin-top: 0;">Promotion Post</a></div>
   <div class="heading"><h1>all posts</h1> <a href="add_movie.php?get_id=<?= $get_id; ?>" class="inline-btn" style="margin-top: 0;">add Movie</a></div>
